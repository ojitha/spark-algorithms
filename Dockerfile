...
RUN curl -fLo /usr/local/bin/coursier https://github.com/coursier/coursier/releases/download/v2.1.9/coursier && \
...
ARG SCALA_VERSIONS
USER $NB_UID
COPY --chown=1000:100 --chmod=755 scripts/install-kernels.sh .
